...
# ============================================================
# AUTOMATIC STUDENT BUS / STOP FEATURES
# ============================================================
...
def get_temporary_stop_change(
    ...
    original_stop = db.query(Stop).filter(Stop.id == change.original_stop_id).first()
...
def get_student_effective_stop(
    ...
    stop, change = get_effective_student_stop(db, student)
    if not stop:
        raise HTTPException(status_code=404, detail="No stop assigned to this student")
